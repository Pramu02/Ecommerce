...
<div class="container-fluid">
	<div class="col-lg-12">
		<form id="manage-product">
			...
			<div class="form-group">
				<img src="<?php echo isset($meta['Image']) ? $meta['Image'] : '' ?>" alt="" id="Image" width="80" height="100">
			</div>
			...
			<div class="form-group input-group">
				...
				<div class="custom-file">
					<input type="file" name="Image" class="custom-file-input" id="Image" onchange="displayImg(this,$(this))">
